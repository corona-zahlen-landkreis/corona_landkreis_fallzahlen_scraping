...
main_url = "https://www.rv.de/Politik+_+Verwaltung/aktuelles+zum+coronaviurs"

prefix_case = "gibt es bei uns"
community_id = "08436"

case_func = lambda bs: helper.extract_case_num(bs.text, prefix_case)
date_func = lambda bs: helper.extract_status_date_directregex(req.text, date_regex, date_format, 0)
